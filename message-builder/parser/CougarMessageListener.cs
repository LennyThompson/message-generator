...
{
    public class SimplObjectCompletion : ObjectCompletion
    {
        ...
        : CougarMessageBuilderBase(builderParent)
    {
        ...
        {
            return new SimplObjectCompletion();
        }
    ...
    public class CougarMessageListener : CougarParserBaseListener
    {
        ...
        public override void ExitFielddesc_money(CougarParser.Fielddesc_moneyContext ctx)
        {
            m_stackBuilders.Peek().ExitFielddesc_money(ctx);
        }

        public override void EnterFielddesc_quoted_string(CougarParser.Fielddesc_quoted_stringContext ctx)
        {
            m_stackBuilders.Peek().EnterFielddesc_quoted_string(ctx);
        }

        public override void ExitFielddesc_quoted_string(CougarParser.Fielddesc_quoted_stringContext ctx)
        {
            m_stackBuilders.Peek().ExitFielddesc_quoted_string(ctx);
        }
    }
}
